...
void doPhysicalBox()
{
    ...
    printp(&pb4);
    printp(&pb1);
    printf("pb4 %s pb1\n", pb4.box.height == pb1.box.height && pb4.box.width == pb1.box.width && pb4.box.length == pb1.box.length && pb4.material.material == pb1.material.material ? "equals" : "does not equal");

    printf("\npb4 is copy-assigned from pb3\n");
    pb4 = pb3;
    printp(&pb4);
    printp(&pb3);
    printf("pb4 %s pb3\n", pb4.box.height == pb3.box.height && pb4.box.width == pb3.box.width && pb4.box.length == pb3.box.length && pb4.material.material == pb3.material.material ? "equals" : "does not equal");
...
void doWeightBox()
{
   ...
   printf("pw4 %s pw1\n", pw4.box.height == pw1.box.height && pw4.box.width == pw1.box.width && pw4.box.length == pw1.box.length && pw4.weight == pw1.weight ? "equals" : "does not equal");

    printf("\npw4 is copy-assigned from pw3\n");
    _ZN9WeightBoxaSERKS_(&pw4,&pw3);
    _ZNK9WeightBox6printwEv(&pw4);
    _ZNK9WeightBox6printwEv(&pw3);
    printf("pw4 %s pw3\n", pw4.box.height == pw3.box.height && pw4.box.width == pw3.box.width && pw4.box.length == pw3.box.length && pw4.weight == pw3.weight ? "equals" : "does not equal");
